...
class NominalVerbState(State):
    def __init__(self, initial_state, final_state, *suffixes):
        super(NominalVerbState, self).__init__(initial_state, final_state, *suffixes)

        if self.initial_state and (not self.final_state):
...
C = NominalVerbState(False, True, NominalVerbSuffix.S10, NominalVerbSuffix.S12, NominalVerbSuffix.S13,
                     NominalVerbSuffix.S14)
D = NominalVerbState(False, False, NominalVerbSuffix.S12, NominalVerbSuffix.S13)
E = NominalVerbState(False, True, NominalVerbSuffix.S1, NominalVerbSuffix.S2, NominalVerbSuffix.S3,
...
H = NominalVerbState(False, False, NominalVerbSuffix.S1, NominalVerbSuffix.S2, NominalVerbSuffix.S3,
                     NominalVerbSuffix.S4, NominalVerbSuffix.S5, NominalVerbSuffix.S14)
...
for sfx in (
        NominalVerbSuffix.S1, NominalVerbSuffix.S2, NominalVerbSuffix.S3, NominalVerbSuffix.S4, NominalVerbSuffix.S5):
    FT_VALUES[sfx] = G
